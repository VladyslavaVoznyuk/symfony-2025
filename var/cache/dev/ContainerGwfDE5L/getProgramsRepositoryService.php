 ...
 */
class getProgramsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProgramsRepository' shared autowired service.
     *
     * @return \App\Repository\ProgramsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProgramsRepository.php';

        return $container->privates['App\\Repository\\ProgramsRepository'] = new \App\Repository\ProgramsRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
