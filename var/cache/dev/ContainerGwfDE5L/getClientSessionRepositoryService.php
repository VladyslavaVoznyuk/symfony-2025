 ...
 */
class getClientSessionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ClientSessionRepository' shared autowired service.
     *
     * @return \App\Repository\ClientSessionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ClientSessionRepository.php';

        return $container->privates['App\\Repository\\ClientSessionRepository'] = new \App\Repository\ClientSessionRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
