 ...
 */
class getTrainerProgramsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TrainerProgramsRepository' shared autowired service.
     *
     * @return \App\Repository\TrainerProgramsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TrainerProgramsRepository.php';

        return $container->privates['App\\Repository\\TrainerProgramsRepository'] = new \App\Repository\TrainerProgramsRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
