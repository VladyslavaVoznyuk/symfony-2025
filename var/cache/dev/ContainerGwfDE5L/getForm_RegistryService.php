...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Form\\ClientProgramsType' => ['privates', 'App\\Form\\ClientProgramsType', 'getClientProgramsTypeService', true],
            'App\\Form\\ClientSessionType' => ['privates', 'App\\Form\\ClientSessionType', 'getClientSessionTypeService', true],
            'App\\Form\\EqipmentType' => ['privates', 'App\\Form\\EqipmentType', 'getEqipmentTypeService', true],
            'App\\Form\\PaymentsType' => ['privates', 'App\\Form\\PaymentsType', 'getPaymentsTypeService', true],
            'App\\Form\\ProgramsType' => ['privates', 'App\\Form\\ProgramsType', 'getProgramsTypeService', true],
            'App\\Form\\SessionType' => ['privates', 'App\\Form\\SessionType', 'getSessionTypeService', true],
            'App\\Form\\TrainersType' => ['privates', 'App\\Form\\TrainersType', 'getTrainersTypeService', true],
            ...
            'App\\Form\\ClientProgramsType' => '?',
            'App\\Form\\ClientSessionType' => '?',
            'App\\Form\\EqipmentType' => '?',
            'App\\Form\\PaymentsType' => '?',
            'App\\Form\\ProgramsType' => '?',
            'App\\Form\\SessionType' => '?',
            'App\\Form\\TrainersType' => '?',
