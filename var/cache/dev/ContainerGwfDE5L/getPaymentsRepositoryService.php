 ...
 */
class getPaymentsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PaymentsRepository' shared autowired service.
     *
     * @return \App\Repository\PaymentsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PaymentsRepository.php';

        return $container->privates['App\\Repository\\PaymentsRepository'] = new \App\Repository\PaymentsRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
