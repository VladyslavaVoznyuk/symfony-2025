...
class __TwigTemplate_395e2d7c60c042d8aed70f6a7500e41c extends Template
{
    ...
    <ul>
        ...
        if (!$context['_iterated']) {
            // line 11
            yield "            <li>Немає продуктів</li>
        ";
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['id'], $context['product'], $context['_parent'], $context['_iterated']);
...
";
    ...
    {
        return array (  112 => 13,  105 => 11,  103 => 10,  94 => 9,  89 => 8,  85 => 6,  75 => 5,  58 => 3,  41 => 1,);
    }
...
{% block body %}
    ...
    <ul>
        {% for id, product in products %}
            <li>{{ id }} – {{ product }}</li>
        {% else %}
            <li>Немає продуктів</li>
        {% endfor %}
    </ul>
{% endblock %}
", "product/index.html.twig", "C:\\wamp64\\www\\symfony-2025\\my_project\\templates\\product\\index.html.twig");
    }
}
