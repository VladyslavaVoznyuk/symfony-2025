...
class getDoctrine_Orm_DefaultConfigurationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\ClientProgramsRepository' => ['privates', 'App\\Repository\\ClientProgramsRepository', 'getClientProgramsRepositoryService', true],
            'App\\Repository\\ClientRepository' => ['privates', 'App\\Repository\\ClientRepository', 'getClientRepositoryService', true],
            'App\\Repository\\ClientSessionRepository' => ['privates', 'App\\Repository\\ClientSessionRepository', 'getClientSessionRepositoryService', true],
            'App\\Repository\\EqipmentRepository' => ['privates', 'App\\Repository\\EqipmentRepository', 'getEqipmentRepositoryService', true],
            'App\\Repository\\PaymentsRepository' => ['privates', 'App\\Repository\\PaymentsRepository', 'getPaymentsRepositoryService', true],
            'App\\Repository\\ProgramsRepository' => ['privates', 'App\\Repository\\ProgramsRepository', 'getProgramsRepositoryService', true],
            'App\\Repository\\SessionRepository' => ['privates', 'App\\Repository\\SessionRepository', 'getSessionRepositoryService', true],
            'App\\Repository\\TrainerProgramsRepository' => ['privates', 'App\\Repository\\TrainerProgramsRepository', 'getTrainerProgramsRepositoryService', true],
            'App\\Repository\\TrainersRepository' => ['privates', 'App\\Repository\\TrainersRepository', 'getTrainersRepositoryService', true],
        ], [
            'App\\Repository\\AttendanceRepository' => '?',
            'App\\Repository\\ClientProgramsRepository' => '?',
            'App\\Repository\\ClientRepository' => '?',
            'App\\Repository\\ClientSessionRepository' => '?',
            'App\\Repository\\EqipmentRepository' => '?',
            'App\\Repository\\PaymentsRepository' => '?',
            'App\\Repository\\ProgramsRepository' => '?',
            'App\\Repository\\SessionRepository' => '?',
            'App\\Repository\\TrainerProgramsRepository' => '?',
            'App\\Repository\\TrainersRepository' => '?',
        ])));
