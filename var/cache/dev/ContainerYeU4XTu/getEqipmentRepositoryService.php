 ...
 */
class getEqipmentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EqipmentRepository' shared autowired service.
     *
     * @return \App\Repository\EqipmentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EqipmentRepository.php';

        return $container->privates['App\\Repository\\EqipmentRepository'] = new \App\Repository\EqipmentRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
