 ...
 */
class getTrainersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TrainersRepository' shared autowired service.
     *
     * @return \App\Repository\TrainersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TrainersRepository.php';

        return $container->privates['App\\Repository\\TrainersRepository'] = new \App\Repository\TrainersRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
