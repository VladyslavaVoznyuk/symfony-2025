 ...
 */
class getClientProgramsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ClientProgramsRepository' shared autowired service.
     *
     * @return \App\Repository\ClientProgramsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ClientProgramsRepository.php';

        return $container->privates['App\\Repository\\ClientProgramsRepository'] = new \App\Repository\ClientProgramsRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
